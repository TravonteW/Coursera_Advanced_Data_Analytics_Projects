...
# Display summary statistics of rows with null values
missing_label_rows.describe()
...
non_missing_label_rows = df.dropna(subset=['label'])

# Display summary statistics of rows without null values
non_missing_label_rows.describe()
